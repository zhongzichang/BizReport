...
import {FETCH_STOCK_DISTRIBUTION_DATA_REQUEST} from '../../constants/action-names';


export const fetchStockDistributionData = (shop_id,product_id) => (
  (dispatch : Function) => {
    dispatch(fetchStockDistributionDataRequest());
...
fetchStockDistributionDataRequest = (resp : Object) => (
  {
    type: FETCH_STOCK_DISTRIBUTION_DATA_REQUEST,
